...
export const footerMenusDataHEB = [
...
export const therapistSafetyDataHEB: Array<DataTypes> = [
  {
...
export const clientSafetyDataHEB: Array<DataTypes> = [
  {
...
export const guaranteesDataHEB: Array<DataTypes> = [
  {
    title: 'Qualified',
...
export const massageTypesHEB: Array<DataTypes> = [
  {
    title: 'Swedish',
...
export const offersDataHEB: Array<OfferTypes> = [
  {
    minutes: 60,
    dollars: 59,
...
export const storyParagraphDataHEB: Array<string> = [
