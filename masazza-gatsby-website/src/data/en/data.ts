...
export const therapistSafetyDataEN: Array<DataTypes> = [
  {
...
export const clientSafetyDataEN: Array<DataTypes> = [
  {
...
export const guaranteesDataEN: Array<DataTypes> = [
  {
    title: 'Qualified',
...
export const massageTypesEN: Array<DataTypes> = [
  {
    title: 'Swedish',
...
export const offersDataEN: Array<OfferTypes> = [
  {
    minutes: 60,
    dollars: 59,
...
export const storyParagraphDataEN: Array<string> = [
