...
export const footerMenusDataRU: Array<ArrayData> = [
...
export const therapistSafetyDataRU: Array<DataTypes> = [
  {
...
export const clientSafetyDataRU: Array<DataTypes> = [
  {
...
export const guaranteesDataRU: Array<DataTypes> = [
  {
    title: 'Qualified',
...
export const massageTypesRU: Array<DataTypes> = [
  {
    title: 'Swedish',
...
export const offersDataRU: Array<OfferTypes> = [
  {
    minutes: 60,
    dollars: 59,
...
export const storyParagraphDataRU: Array<string> = [
